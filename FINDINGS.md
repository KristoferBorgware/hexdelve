...
than done.
### F-035 — The small kobold's stand does not start at rest, so a stab ends a hair off where the idle begins
...
**Closed:** 2026-09-05, fixed — deleted. The level view has no pattern
panel and nobody wanted one back, so the file went rather than being kept
against a caller that might return.
