...
|---|---|---|
| `birth_randarts` | off | At accept, `do_randart()` replaces the standard artifact set with a randomly generated one of equivalent power (see the Objects chapter). Spoilers and knowledge screens use the randart names. |
